 ...
 */
angular.module('testingItApp', [ 'ngAnimate', 'ngCookies', 'ngResource', 'ui.router', 'ngSanitize', 'restangular', 'environment', 'restangular', 'angularBootstrapNavTree', 'ui.grid', 'ui.grid.edit', 'ui.grid.cellNav', 'ui.bootstrap'])
